...
import com.example.bf_kotlin_client.dtos.requests.ImageRequest
...
class ImageApiWorker {
    fun getImage(path:String,successCallbackFunction: (Bitmap) -> Unit) {
        val appAuthRequest = ImageRequest(path)
        ...
        val url = "http://151.248.113.116:8080/mobile/test/getPictureFile"
